...
export class WorldComponent implements AfterViewInit {
	...
	*/
	...
	private generateGamePieceContainers(): void {
		...
		const playerOneContainer = Bodies.rectangle(this.width * 0.132, this.height / 2, 200, 340, pieceContainerOptions);
		const playerTwoContainer = Bodies.rectangle(this.width * 0.868, this.height / 2, 200, 340, pieceContainerOptions);
